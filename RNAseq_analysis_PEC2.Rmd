...
```{r display log fold changes versus expression strength, fig.cap='Gráficas mostrando expresion diferencial (log-fold changes) frente a fuerza de expresion (media de cuentas normalizadas). Los puntos rojos representan los genes con un p-valor ajustado inferior a 0.1 (FDR 10%)'}
par(mfrow = c(2, 2))
plotMA(res_SFIvsNIT,
       alpha = 0.1,
       main = 'SFI-NIT',
...
Lo genes representados en el mapa de calor, aquellos 20 que presentan mayor variación intermuestral, parecen dividirse en dos grandes grupos.
