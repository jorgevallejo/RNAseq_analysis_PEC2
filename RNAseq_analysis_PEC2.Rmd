...
Como hay tres grupos, el análisis de expresión diferencial lo he efectuado sobre tres comparaciones: SFI-NIST, ELI-NIST y ELI-SFI.
...
kable(as.data.frame(cbind(Muestras = names(sizeFactors(ddsMat)),
                    ...
                    row.names = NULL),
      row.names = FALSE,
      caption = 'Factores de normalización aplicados a cada muestra (redondeados a 4 dígitos). Obsérvese que ninguno de los factores se aleja excesivamente de la unidad, lo que apunta a que ninguna de las muestras estudiadas tiene una profundidad de lectura muy alejada del resto.',
      align = 'rl'))
```
